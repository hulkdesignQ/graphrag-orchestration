...
### Step 2 — Ask Your Documents

1. Click **Chat** in the sidebar
2. Select the folder containing your documents from the folder dropdown
3. Type your question in natural language — in any of 13 supported languages
4. Press Enter or click Send

Evidoc doesn't just search keywords — it understands relationships across all your documents and retrieves precise answers with citations.

**Try questions like:**
- *"What are the payment terms in the contract?"*
- *"Do the invoice amounts match the agreed rates?"*
- *"Which documents mention a termination clause?"*
- *"Summarize the key obligations across all agreements"*

### Step 3 — Verify Every Answer

Every answer includes **citations** — clickable references to the exact sentence in the original document.
...
## For B2B / Enterprise Teams

If your organization uses Evidoc with Azure AD (Entra ID) integration:

1. **Sign in** with your corporate credentials — your admin has already configured access
2. **Group-based isolation** ensures your team's documents are only visible to your group
3. **Role-based access:** Users can upload and query; Admins can also access the admin dashboard for system diagnostics
4. Contact your administrator for folder setup and document provisioning
...
| Tip | Why |
|-----|-----|
| **Upload related documents together** | Group contracts, invoices, and amendments in one folder for cross-document Q&A |
| **Be specific in your questions** | *"What is the penalty for late delivery under section 5?"* works better than *"Tell me about penalties"* |
| **Use comparison questions** | *"Do the prices in Invoice #3 match the contract?"* triggers inconsistency detection |
| **Click citations to verify** | Every answer is only as trustworthy as its source — verify critical findings |
| **Try different phrasings** | If the first answer isn't perfect, rephrase — different wording may retrieve different relevant passages |

---

## Supported File Formats

PDF, DOCX, XLSX, PPTX, HTML, TXT, CSV, PNG, JPG, JPEG, BMP, TIFF — and more via Azure Document Intelligence OCR.
