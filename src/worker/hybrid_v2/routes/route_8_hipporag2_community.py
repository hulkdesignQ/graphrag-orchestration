...
class HippoRAG2CommunityHandler(BaseRouteHandler):
    ...
    QUERY_MODE_PRESETS: Dict[str, Dict[str, Any]] = {
        ...
        "comprehensive_search": {      # APPNP Neural PPR — exhaustive cross-doc retrieval
            ...
            "appnp_alpha": 0.65,  # teleportation: 65% reranker + 35% graph; same recall as 0.80 with more graph contribution
        ...
        async with self._init_lock:
            ...
            await asyncio.gather(
                ...
                ppr_engine.load_graph(
                    ...
                    monopartite_cross_community_dampen=monopartite_cross_community_dampen,
